...
2.  **获取人设**：在 [../cast/](../cast/) 目录下读取目标角色的 JSON。
3.  **确认地点**：在 [../bibles/WORLD.md](../bibles/WORLD.md) 确认地理环境逻辑。
4.  **生成脚本**：按照 [../episodes/FINAL_SCRIPT_FORMAT.md](../episodes/FINAL_SCRIPT_FORMAT.md) 的 15s 结构输出。
